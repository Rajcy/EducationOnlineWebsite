...
(function(b, f) {
    jPlayerPlaylist = function(a, c, d) {
		...
		this.cssSelector.photo = this.cssSelector.cssSelectorAncestor + ".jp-progress";
    ...
    jPlayerPlaylist.prototype = {
        ...
        _highlight: function(a) {
			...
			//�����
			this.playlist.length && a !== f &&(b(".list-group"+ " .active").removeClass("active"),
			b(".list-group" + " .list-group-item:nth-child(" + (a + 1) + ")").addClass("active").find(".jp-play-me").addClass("active"),
